...
<form method="post" action="${pageContext.request.contextPath}/UpdateBoard.free">
	...
	<fieldset>
		...
		<div class="text-center">
  			<button type="button" onclick="updateBoard()" class="btn btn-primary">수정하기</button>
			<button type="button" onclick="location.href='free-board-list.jsp'" class="btn btn-outline-secondary">취소하기</button>			
		</div>
	</div>
