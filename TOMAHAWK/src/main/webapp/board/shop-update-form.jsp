...
<fieldset>
    ...
    <a href="${pageContext.request.contextPath}/index.jsp"><img src="${pageContext.request.contextPath}/images/searchcon2.png"></a>
              ...
              <div class="card">
                <div class="card-body">
                  <h1 class="card-title"><span style='font-size:100px;'>&#128221;</span>식당게시판 글수정</h1>
                  <hr style="border-top: 3px solid gray"> 
                  <div class="alert alert-warning" role="alert">
                    수정시에는 식당 이미지를 변경을 할 수 없습니다.<br>글삭제후 다시 작성해주세요.
                  </div><br>
                  <form class="forms-sample" method="post" action="${pageContext.request.contextPath}/UpdateShop.do">
                  <input type="hidden" name="shopNo" value="${shop.shopNo }">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="shopName" name="shopName" placeholder="이곳에 식당명을 입력해주세요." required="required" value="${shop.shopName }">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="nick" class="col-sm-3 col-form-label"><strong>&#128587;식당 분류</strong></label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="shopType" placeholder="이곳에 식당 분류를 입력해주세요." required="required"value="${shop.shopType }">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="nick" class="col-sm-3 col-form-label"><strong>&#128587;식당 주소</strong></label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="shopAddress" placeholder="이곳에 식당 주소를 입력해주세요." required="required" value="${shop.shopAddress }">
                      </div>
                    </div>
					<div class="text-center">
			  			<button type="button" onclick="updateShop()" class="btn btn-primary">완료</button>
