    ...
    <a href="${pageContext.request.contextPath}/index.jsp"><img src="${pageContext.request.contextPath}/images/searchcon2.png"></a>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" action="${pageContext.request.contextPath}/NoticeWrite.do">
					...
					<div class="text-center">
						...
						<button type="button" onclick="location.href='${pageContext.request.contextPath}/board/notice-board-list.jsp'" class="btn btn-outline-secondary">취소</button>			
					</div>
                  </form>
                </div>
              </div>
