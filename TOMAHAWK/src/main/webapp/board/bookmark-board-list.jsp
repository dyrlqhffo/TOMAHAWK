...
<br>
<input type="hidden" id="sessionEmail" name="sessionEmail" value="${sessionScope.mvo.email}">
	<table class="table table-boarderd table-hover boardlist">
			...
			<ul class="pagination justify-content-center" style="margin:20px 0">	
				<c:if test="${pagination.previousPageGroup}">
					<li class="page-item"><a class="page-link" href="BookmarkList.do?pageNo=${pagination.startPageOfPageGroup - 1}">이전</a></li>
				</c:if>
				...
				<c:if test="${pagination.nextPageGroup}">		
			  		<li class="page-item"><a class="page-link" href="BookmarkList.do?pageNo=${pagination.endPageOfPageGroup + 1}">다음</a></li>
			  	</c:if>     
			</ul>
</div>
</body>
