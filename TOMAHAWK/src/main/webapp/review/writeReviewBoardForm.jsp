...
<fieldset>
    ...
    <a href="${pageContext.request.contextPath}/index.jsp"><img src="${pageContext.request.contextPath}/images/searchcon2.png"></a>
              ...
              <div class="card">
                <div class="card-body">
                  <h1 class="card-title"><span style='font-size:100px;'>&#128221;</span>리뷰 게시판 글쓰기</h1>
                  <hr style="border-top: 3px solid gray"> 
                  <div class="alert alert-warning" role="alert">
                    아래의 입력란을 채워주세요.
                  </div><br>
                  <form class="forms-sample" method="post" action="${pageContext.request.contextPath}/WriteReviewBoard.do"  id="insertReviewBoard">
                    <div class="form-group row">
                      <label for="title" class="col-sm-3 col-form-label"><strong>&#128204;글 제목</strong></label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="title" name="title" placeholder="이곳에 제목을 입력해주세요." required="required">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <select class="boardType" id="type" name="type">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
					  <textarea id="summernote" rows="10" class="form-control" name="content" id="content" placeholder="본문내용" required="required">${board.content}</textarea>
							<script>
					...
					<div class="text-center">
			  			<button type="button" onclick="writeReviewBoard(event)" class="btn btn-primary">완료</button>
...
<script type="text/javascript">
	...
	function writeReviewBoard(event){
		let title = $("#title");
		...
		document.getElementById('insertReviewBoard').submit();
	}		
