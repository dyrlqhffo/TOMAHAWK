    ...
    <a href="${pageContext.request.contextPath}/index.jsp"><img src="${pageContext.request.contextPath}/images/searchcon2.png"></a>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" id="updateReviewBoard-form" method="post" action="${pageContext.request.contextPath}/UpdateReviewBoard.do">
					...
					<div class="text-center">
			  			<button type="button" onclick="updateBoard(event)" class="btn btn-primary" id="upd-btn">수정하기</button>
...
function updateBoard(event) {
	...
	function updateReviewBoard(event){
